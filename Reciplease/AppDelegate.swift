...
//  Reciplease
//
//  Created by Paul Leclerc on 16/09/2019.
...
// MARK: Core Data
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        container.loadPersistentStores(completionHandler: { (storeDescription, error) in //swiftlint:disable:this unused_closure_parameter line_length
